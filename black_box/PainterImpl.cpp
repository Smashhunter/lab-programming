...
void
PainterImpl::draw(const Point& center, double radius, const Color& color)
{
...
void
PainterImpl::draw(const Point& topLeft,
...
sf::Color
PainterImpl::toSFMLColor(const Color& color) const
{
...
sf::Vector2f
PainterImpl::toVector(const Point& point) const
{
